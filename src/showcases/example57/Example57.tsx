...
export default function Example57({ navigate }: { navigate: (path: string) => void }) {
  ...
  return (
    <main className="showcase-page e57" style={{ "--bg": tokens.background, "--surface": tokens.surface, "--text": tokens.text, "--muted": tokens.muted, "--primary": tokens.primary } as CSSProperties}>
